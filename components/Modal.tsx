          ...
          <div>
             <div className="flex items-center gap-3 mb-2">
                <span className={`inline-block px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-wide border ${
                    ...
                    entry.risk_level === 'High' ? 'bg-warning text-slate-900 border-warning' : 
                ...
                <div className="bg-slate-950 border border-slate-800 p-4 rounded-lg">
                    ...
                    <ul className="space-y-2 text-sm text-slate-300">
                        ...
                        {entry.breakdown_scores.far_right_focus >= 3 && (
                            <li className="flex items-start text-warning"><i className="fa-solid fa-circle-exclamation mt-1 mr-2 text-xs"></i> Exclusive Far-Right Focus</li>
                        )}
                    </ul>
                </div>
                <div className="bg-slate-950 border border-slate-800 p-4 rounded-lg">
