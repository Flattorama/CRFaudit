  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-800 py-24 text-center">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl md:text-6xl font-condensed font-bold text-white uppercase mb-6">Security Demands Parity</h2>
        
        <p className="text-slate-400 text-lg md:text-xl max-w-3xl mx-auto mb-12 leading-relaxed font-sans">
          The 2025 CRF portfolio is a perfect inversion of reality. It funds a map that does not match the territory. We don't need to defund research into the Far-Right; we need to match it with equal resources for the threats actually killing people: Islamist Extremism and Antisemitism.
        </p>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          ...
          <a href="#methodology" className="text-paper underline decoration-slate-600 hover:decoration-paper underline-offset-4 font-mono text-sm hover:text-white transition-colors">
