  ...
  return (
    <div className="min-h-screen font-sans selection:bg-danger selection:text-white bg-slate-950">
      ...
      <main>
        ...
        <section className="max-w-7xl mx-auto px-4 py-24 border-t border-slate-800" id="methodology">
                ...
                <div className="lg:col-span-1 flex flex-col gap-4">
                    <div className="bg-slate-900 p-8 border border-slate-700 h-full">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start p-4 bg-slate-950 border border-warning rounded-sm">
                                <div className="h-10 w-10 bg-warning flex items-center justify-center text-slate-900 font-bold shrink-0 font-mono">
                                    10-14
                                </div>
                                <div className="ml-4">
                                    <h4 className="text-warning font-bold uppercase text-sm font-condensed text-lg">High Risk</h4>
                                    <p className="text-xs text-slate-400 mt-1">Generic framing that obscures specific ideological dangers.</p>
                                </div>
                            </div>

                            <div className="flex items-start p-4 bg-slate-950 border border-success rounded-sm">
                                <div className="h-10 w-10 bg-success flex items-center justify-center text-white font-bold shrink-0 font-mono">
                                    &lt;9
                                </div>
                                <div className="ml-4">
                                    <h4 className="text-success font-bold uppercase text-sm font-condensed text-lg">Medium/Low Risk</h4>
